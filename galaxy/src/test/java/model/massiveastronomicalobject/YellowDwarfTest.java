...
//        YellowDwarf yellowDwarf = new YellowDwarf(1.0, 0.6);
//        Orbit orbita = new Orbit.Builder(planet).star(yellowDwarf).height(1000.0).build();
//        double actual = getAttitude(yellowDwarf, orbita);
//        assertTrue(actual < attitude);
//
//    }
//
//    public double getAttitude(Star star, Orbit orbita) {
